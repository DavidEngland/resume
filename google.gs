...
Google document script to generate resume/cv from JSONresume.
...
*/
  ...
  */
  ...
  for (var i = 0; i < r.education.length; i++) {
    ...
    if (r.education[i].gpa) {
      degree.getRow(0).getCell(1).appendParagraph('GPA:  ' + r.education[i].gpa);
    }
